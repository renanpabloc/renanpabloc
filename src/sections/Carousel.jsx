...
export default function Carousel() {
  ...
  const posts = [
    { src: "/news/carousel-1.png", alt: "Carrossel 1" },
    { src: "/news/carousel-2.png", alt: "Carrossel 2" },
    { src: "/news/carousel-3.png", alt: "Carrosel 3" },
  ];
  ...
  const desktopImage = { src: "/news/desktop2.png", alt: "Carrossel" };
